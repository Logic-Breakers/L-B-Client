...
export default function Footer(){
    return (
        <footer className="bg-gray-100 border-t-[1px] border-solid border-[#cccccc] px-[40px]">
            <section className="grid grid-cols-3 py-[48px] text-[14px]">
                <div>
            ...
            <section className="border-t-[1px] border-solid border-[#cccccc] py-[24px] ">
                <section className="flex flex-row justify-between">
                    <div className="flex flex-row items-center gap-[6px] text-[14px] text-[--menu-gray-color] ">
