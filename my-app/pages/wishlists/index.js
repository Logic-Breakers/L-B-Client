                        ...
                        <ul className="grid bnb_xl:grid-cols-4 bnb_md_lg:grid-cols-3 bnb_sm:grid-cols-2 gap-[24px] my-[24px]">
                            {wishlistsDummy.map(el =>
                                <li key={el.id} className="relative rounded-[16px]">
                                    <button type="button" onClick={deleteItem} className={`absolute top-[10px] left-[10px] text-[20px] px-[8px] rounded-[20px] border-[1px] border-gray-400 bg-gray-100 shadow-xx hover:shadow-xxx hover:bg-[#fff] hover:scale-105 transition duration-200 ease-in-out`}>
                                        ✕
                                    </button> 
                                    <Link href='/'>
                                        <div>
                                            <Image src={el.picture} width="100" height="100" alt="picture" className="w-[100%] rounded-[12px] p-[4px] shadow-cc"/>
